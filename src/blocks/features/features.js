module.exports = {
    ...
    features: [
        ...
        {
            id: "two-way-orders",
            title: "Двусторонний обмен заказами",
            description: "Двусторонний обмен информацией о заказах между вашим сайтом и 1С.",
        ...
        },
        {
            id: "logging",
            title: "Логирование",
            description: "Полное логирование процесса синхронизации. Доступно как отдельная услуга.",
            icon: "journal-text"
        },
        {
